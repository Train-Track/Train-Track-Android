...
public class ServiceItemDepartureRowAdapter extends RecyclerView.Adapter<ServiceItemViewHolder> {
     ...
     */
    public ServiceItemDepartureRowAdapter(ArrayList<ServiceItem> serviceItems) {
