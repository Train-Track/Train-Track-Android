...
public class StationBoard {
	...
	public static StationBoard getByCrs(String crs) {
		...
		String xmlResponse = "";
		if (Utils.DEBUG_MODE) {
			xmlResponse = "<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetArrivalDepartureBoardResponse xmlns=\"http://thalesgroup.com/RTTI/2012-01-13/ldb/types\"><GetArrivalDepartureBoardResult><generatedAt>2014-10-18T00:41:49.1177966+01:00</generatedAt><locationName>London Paddington</locationName><crs>PAD</crs><platformAvailable>true</platformAvailable><trainServices><service><origin><location><locationName>Oxford</locationName><crs>OXF</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></destination><sta>00:27</sta><eta>00:40</eta><platform>9</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>aJbyv/IEwjMUxzud/F3itA==</serviceID></service><service><origin><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>Reading</locationName><crs>RDG</crs><via /><futureChangeTo /></location></destination><std>00:34</std><etd>Delayed</etd><platform>9</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>9iVb1dqkSRrG0wCewphwww==</serviceID></service><service><origin><location><locationName>Taunton</locationName><crs>TAU</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></destination><sta>00:34</sta><eta>00:42</eta><platform>10</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>oBvDDYUSISYFvl9HhCYYhg==</serviceID></service><service><origin><location><locationName>Reading</locationName><crs>RDG</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></destination><sta>01:16</sta><eta>On time</eta><platform>9</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>0/H2j1bnJCZtOlYq6ATNwg==</serviceID></service><service><origin><location><locationName>Hereford</locationName><crs>HFD</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></destination><sta>01:22</sta><eta>On time</eta><platform>10</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>//8hNcU0IBuOfAfSeEOkfg==</serviceID></service><service><origin><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>Reading</locationName><crs>RDG</crs><via /><futureChangeTo /></location></destination><std>01:44</std><etd>On time</etd><platform>9</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>DqyuhPYdwM3BY213CB+dEA==</serviceID></service><service><origin><location><locationName>Banbury</locationName><crs>BAN</crs><via /><futureChangeTo /></location></origin><destination><location><locationName>London Paddington</locationName><crs>PAD</crs><via /><futureChangeTo /></location></destination><sta>02:07</sta><eta>On time</eta><platform>14</platform><operator>First Great Western</operator><operatorCode>GW</operatorCode><serviceID>AEhCbIOeEqJMBfsk94nb+w==</serviceID></service></trainServices></GetArrivalDepartureBoardResult></GetArrivalDepartureBoardResponse></soap:Body></soap:Envelope>";
		} else {
